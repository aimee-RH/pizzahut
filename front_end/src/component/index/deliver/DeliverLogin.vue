...
<template>
  <div class="box">
    ...
    <div class="right">
      ...
      <div class="fn">
        <router-link to="/deliver/register" style="color: rgb(150,8,8);">注册账号</router-link>
        <router-link to="/deliver/alterPassword" style="color: rgb(150,8,8);">忘记密码</router-link>
      </div>
    </div>
  </div>
</template>
...
::selection {
  color: #fff;
  background-color: rgb(88, 224, 58);
...
.box .left::before {
  ...
  width: 100%;
  height: 100%;
  background-image: url("@/assets/images/deliverPoster.png");
...
.box .right form .acc {
  ...
  border: none;
  border-bottom: 2px solid rgb(164, 21, 33);
  color: rgb(140, 62, 69);
